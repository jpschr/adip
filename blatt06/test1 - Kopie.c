...
void createMatrix(int m, int n, matrix* fertigeMatrix){
    int i,j;
...
int main(void){
    ...
    createMatrix(m, n, matrix_a);
    matrix_b = malloc(m * sizeof(int*));
    createMatrix(o, p, matrix_b);
    matrix_c = malloc(m * sizeof(int*));
    createMatrix(m, p, matrix_c);
